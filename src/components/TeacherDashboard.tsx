...
export function TeacherDashboard() {
  ...
  const upcoming = allAssignments.filter((a: any) => new Date(a.date) >= today);
  const past = allAssignments.filter((a: any) => new Date(a.date) < today);
